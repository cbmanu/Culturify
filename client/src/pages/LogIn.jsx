                  ...
                  <div className="row g-0">
                    ...
                    <div className="col-lg-6 d-flex align-items-center gradient-custom-2">
                      <div className="text-white px-3 py-4 p-md-5 mx-md-4">
                        ...
                        <p className="mb-0">
                          ¿Eres un apasionado de la cultura? ¿Te encanta
                          descubrir eventos culturales, festivales, y
                          actividades que enriquecen tu vida? ¡Entonces
                          Culturify es para ti! Culturify es tu puerta de
                          entrada a un mundo lleno de experiencias culturales.
                          Nuestra plataforma está diseñada para conectar
                          personas como tú con una vibrante comunidad de amantes
                          de la cultura. Organiza, descubre y participa en
                          eventos que te inspiran y te conectan con tu pasión
                          por la cultura.
                        </p>
                      </div>
                    </div>
